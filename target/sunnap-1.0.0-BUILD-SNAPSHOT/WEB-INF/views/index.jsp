		...
		<div class="row">
			<div class="col-md-12">
				...
				<div class="content-block">
					<h1>Car Nap Joy </h1>
					<p>"Indulge in the purchase of pure comfort – experience the allure of our cozy haven." <br> -Hong Woo Jin-</p>
...
<div class="product-item bg-light">
	<div class="card">
		<div class="thumb-content">
			...
			<a href="single.html">
				<img class="card-img-top img-fluid" src="<c:url value='/images/products/products-1.jpg'/>" alt="Card image cap">
			</a>
		</div>
		<div class="card-body">
...
<div class="product-item bg-light">
	<div class="card">
		<div class="thumb-content">
			<!-- <div class="price">$200</div> -->
			<a href="single.html">
				<img class="card-img-top img-fluid" src="<c:url value='/images/products/products-2.jpg'/>" alt="Card image cap">
			</a>
		</div>
		<div class="card-body">
...
<div class="product-item bg-light">
	<div class="card">
		<div class="thumb-content">
			<!-- <div class="price">$200</div> -->
			<a href="single.html">
				<img class="card-img-top img-fluid" src="<c:url value='/images/products/products-3.jpg'/>" alt="Card image cap">
			</a>
		</div>
		<div class="card-body">
		    <h4 class="card-title"><a href="single.html">11inch Macbook Air</a></h4>
      ...
      <div class="col-lg-4 col-md-7">
        ...
        <div class="block-2 app-promotion">
          ...
          <div class="download-btn d-flex my-3">
            <a href="index.html"><img src="<c:url value='/images/apps/google-play-store.png'/>" class="img-fluid" alt=""></a>
            <a href="index.html" class=" ml-3"><img src="<c:url value='/images/apps/apple-app-store.png'/>" class="img-fluid" alt=""></a>
          </div>
        </div>
      </div>
    </div>
