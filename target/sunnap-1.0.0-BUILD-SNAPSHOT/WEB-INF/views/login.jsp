								...
								<ul class="dropdown-menu">
									...
									<li class="dropdown dropdown-submenu dropright">
										...
										<ul class="dropdown-menu" aria-labelledby="dropdown0501">
											<li><a class="dropdown-item" href="index.jsp">Submenu 01</a></li>
											<li><a class="dropdown-item" href="index.jsp">Submenu 02</a></li>
										</ul>
									</li>
								</ul>
							</li>
      ...
      <div class="col-lg-5 col-md-8 align-item-center">
        <div class="border">
          <h3 class="bg-gray p-4">Login Now</h3>
            ...
            <fieldset class="p-4">
              <input class="form-control mb-3" name="email" type="text" value="${cookie.email.value}" placeholder="Email" required>
              <input class="form-control mb-3" name="pwd" type="password" placeholder="Password" required>
                <input type="hidden" name="toURL" value="${param.toURL}">
              <div class="loggedin-forgot">
                <input type="checkbox" name="rememberId" id="keep-me-logged-in" ${empty cookie.email.value ? "":"checked"}/>
                <label for="keep-me-logged-in" class="pt-3 pb-2" >Keep me logged in</label>
              </div>
              <button type="submit" class="btn btn-primary font-weight-bold mt-3">Log in</button>
              <a class="mt-3 d-block text-primary" href="#!">Forget Password?</a>
              <a class="mt-3 d-inline-block text-primary" href="<c:url value='/register/add'/>">Register Now</a>
            </fieldset>
          </form>
        </div>
      </div>
      ...
      <div class="col-lg-4 col-md-7">
        ...
        <div class="block-2 app-promotion">
          ...
          <div class="download-btn d-flex my-3">
              <a href="index.jsp"><img src="<c:url value='/images/apps/google-play-store.png'/>" class="img-fluid" alt=""></a>
              <a href="index.jsp" class=" ml-3"><img src="<c:url value='/images/apps/apple-app-store.png'/>" class="img-fluid" alt=""></a>
          </div>
        </div>
      </div>
    </div>
