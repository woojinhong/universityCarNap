        ...
        <div class="border border">
          ...
          <form action="<c:url value="/register/save"/>" method="POST">
            <fieldset class="p-4">
              ...
              <input class="form-control mb-3" type="password" name="pwd" placeholder="Password*" required>
              <input class="form-control mb-3" type="password" placeholder="Confirm Password*" required>
                <input class="form-control mb-3" type ="text" name="firstName" placeholder="WooJin" required>
                <input class="form-control mb-3" type ="text" name="lastName" placeholder="Hong" >
                <input class="form-control mb-3" type ="text" name="birth" placeholder="2000/01/01" required>
